#!/bin/sh
export LIB_GCC=/usr/local/lib/gcc/x86_64-apple-darwin13.0.0/4.9.0/
export DYLD_LIBRARY_PATH=$DYLD_LIBRARY_PATH:/usr/local/lib/gcc/x86_64-apple-darwin13.0.0/4.9.0/:/
